...
export const SectionBuilderThree: Field = {
  name: 'sectionBuilderThree',
  ...
  admin: {
    condition: (data, siblingData, { user }) => {
      ...
      return findProjectLevel === 'levelstoone_3'
    },
  },
  blocks: [Hero, TextImage, TableCustom], // přidej další bloky dle potřeby
}
